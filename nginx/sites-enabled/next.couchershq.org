...
server {
    ...
    location / {
        ...
        proxy_pass https://couchers-dev-assets.s3.amazonaws.com/frontend/develop;
    }

    location @index {
        proxy_pass https://couchers-dev-assets.s3.amazonaws.com/frontend/develop/index.html;
    }
}
